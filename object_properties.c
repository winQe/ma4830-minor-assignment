        ...
        */
        ...
        switch(objectType)
            ...
            case 1:; //Rectangle properties
                ...
                printf("Area : %.2f",result1[0]*result1[1]); //area = length*height
                break;
            case 2:; //Square properties
                ...
                printf("Area : %.2f",pow(result2[0],2)); // area = length^2
                break;
            case 3:; //Circle properties
                ...
                printf("Area : %.2f",M_PI*pow(result3[0],2)); // area = pi*r^2
                break;
            case 4:; //RightTriangle properties
                ...
                printf("Area : %.2f",result4[0]*result4[1]/2); // area = base length * height / 2
                break;
